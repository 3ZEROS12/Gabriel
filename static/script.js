            ...
            if (toast && toastContent) {
                ...
                toastContent.innerHTML = `
                    <div class="insight-card-header">
                        <span><img src="/static/assets/botanical_icon_quick.png" class="rose-stem-badge" alt="Rose Badge"> ${ICONS.zap} Agent Instruction / Insight</span>
                        <div>
...
document.getElementById('btnSend').addEventListener('click', () => {
    ...
    thinkingDiv.innerHTML = '<img src="/static/assets/botanical_icon_quick.png" class="rose-bud-pulse-icon" alt="Rose Bud"> <span class="typing-dot"></span><span class="typing-dot"></span> Gabriel 思考中...';
